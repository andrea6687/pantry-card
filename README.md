...
Gestore intelligente della dispensa per Home Assistant. Scansiona i codici a barre dei prodotti in dispensa con la fotocamera del telefono, recupera automaticamente i dati dei prodotti da [Open Food Facts](https://world.openfoodfacts.org/), tieni traccia delle scadenze, gestisci le quantità e ricevi notifiche prima che il cibo scada. 
...
A smart pantry manager for Home Assistant. Scan your pantry products barcodes with your phone camera, fetch product data automatically from [Open Food Facts](https://world.openfoodfacts.org/), track expiry dates, manage quantities, and get notified before food expires.
